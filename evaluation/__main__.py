"""CLI: python -m evaluation [--system gated_rag|no_rag|compare|scorecard]."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--system",
        choices=("gated_rag", "no_rag", "compare", "scorecard"),
        default="gated_rag",
        help=(
    ...
    parser.add_argument(
        "--rubric",
        action="store_true",
        help="Also run optional LLM-as-judge coaching rubric (costs tokens)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    if args.system == "compare":
        ...
        print("See evaluation/reports/latest_compare.md and latest_scorecard.md")
        return 0
